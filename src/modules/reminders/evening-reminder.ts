...
const eveningReminder = async () => {
  ...
  if (todayTask) {
    ...
    Bugun ${todayCommitCounts} ta commit yozdingiz, kun oxirigacha yana 4 soat vaqtingiz bor, 00:00 gacha ${stockCommit} ta commit yozishingiz kerak. Agarda limitni bajarmasangiz jarima yoziladi!!`;
